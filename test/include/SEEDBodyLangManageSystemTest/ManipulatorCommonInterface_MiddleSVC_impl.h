// -*-C++-*-
/*!
 * @file  ManipulatorCommonInterface_MiddleSVC_impl.h
 * @brief Service implementation header of ManipulatorCommonInterface_Middle.idl
 *
 */
...
#endif // MANIPULATORCOMMONINTERFACE_MIDDLESVC_IMPL_H
